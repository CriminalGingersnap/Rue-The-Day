...
def fillVisibilityMap(rank, position, row, column, battleMap, sightMap):
    ...
    if (row < 11):
        if (column > 0): fillThirdQuadrant(rank, position, row, column, battleMap, sightMap)
        if (column < 11): fillFourthQuadrant(rank, position, row, column, battleMap, sightMap)
...
def fillThirdQuadrant(rank, position, row, column, battleMap, sightMap):
    newRow, newColumn = row + 1, column - 1
    
    if rank != "player":
        Visibility.lookLeft(rank, position, newRow, newColumn, battleMap, sightMap)
        Visibility.lookDown(rank, position, newRow, newColumn, battleMap, sightMap)
    else:
        Visibility.lookDownLeft(rank, position, row, newColumn, battleMap, sightMap)
        Visibility.lookDownLeft(rank, position, newRow, column, battleMap, sightMap)


def fillFourthQuadrant(rank, position, row, column, battleMap, sightMap):
    newRow, newColumn = row + 1, column + 1
    ...
    if rank != "player":
        ...
        Visibility.lookDownRight(rank, position, newRow, column, battleMap, sightMap)
        Visibility.lookDownRight(rank, position, row, newColumn, battleMap, sightMap)