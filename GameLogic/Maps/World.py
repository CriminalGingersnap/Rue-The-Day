...
class AvariceMap:
    def __init__(self) -> None:
        ...
        row19 = ["~~~~⇓","~~~~⇓","~~~~⇓","s___↓","K/!!|","////⇑","////⇑","k___|","////⇑","b___↑","////⇑","O***↑"]
        row20 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","k___|","k___|","k___|","////⇑","b___|","////⇑","////⇑","~~~~↓"]
        row21 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","s___↓","k___|","~~~~↓","b___|","~~~~↓","~~~~↓","////⇑"]
        row22 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","////⇑","k___|","~~~~↓","~~~~↓","~~~~↓","b___↑","b___↑","////⇑"]
        row23 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","s___↓","////⇑","////⇑","~~~~↓","~~~~↓","////⇑","b___↑","////⇑"]
        row24 = ["~~~~⇓","~~~~⇓","~~~~⇓","////⇑","~~~~↓","~~~~↓","////⇑","~~~~↓","~~~~↓","~~~~↓","////⇑","////⇑"]
        ...
        self.legend = {"d": "Dreamwood Periphery", "D": "Dreamwood Depths", "f": "Flame Peninsula", "F": "Flame Volcano",
                        "i": "Ice Fjord", "I": "Ice Glacier", "K": "Kingdom Fort", "k": "Kingdom Road",
                         "o": "Outlaw Range", "O": "Outlaw Camp", "s": "Shoreline Dunes",
        ...
        self.events = {"Escape": {"location": [14, 6], "complete": False},
                        "Threshold": {"location": [10, 5], "complete": False}, "Moose": {"location": [5, 10], "complete": False}, "Vines": {"location": [1, 7], "complete": False}, 
                         "Worm": {"location": [1, 11], "complete": False}, "Giant": {"location": [0, 5], "complete": False}, "Strider": {"location": [7, 1], "complete": False},
                          "Breakout": {"location": [16, 7], "complete": False}, "Camp": {"location": [18, 11], "complete": False}, "Finale": {"location": [18, 4], "complete": False},
...
class chrysalisMap:
    def __init__(self) -> None:
        ...
        row6  = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~↓","////⇑","////⇑","T___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row7  = ["~~~~⇓","~~~~⇓","m___↓","M___|","~~~~↓","////⇑","////⇑","T___⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row8  = ["~~~~⇓","m_..↓","M___|","////⇑","t___↑","T___⇑","////⇑","T___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓"]
        row9  = ["~~~~⇓","~~~~⇓","m___↓","M___|","~~~~↓","~~~~↓","////⇑","////⇑","t___↑","////⇑","~~~~⇓","~~~~⇓"]
        row10 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~↓","////⇑","////⇑","////⇑","D___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓"]
        row11 = ["~~~~⇓","~~~~⇓","~~~~⇓","m___↓","M___|","~~~~↓","////⇑","T___⇑","////⇑","////⇑","~~~~⇓","~~~~⇓"]
        row12 = ["~~~~⇓","~~~~⇓","~~~~⇓","m___↓","~~~~↓","////⇑","T___⇑","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓"]
        row13 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~↓","M___|","t___↑","~~~~↓","////⇑","////⇑","~~~~⇓","////⇑","~~~~⇓"]
        row14 = ["~~~~⇓","~~~~⇓","~~~~⇓","m___↓","~~~~↓","~~~~↓","////⇑","////⇑","~~~~⇓","////⇑","~~~~⇓","~~~~⇓"]
        row15 = ["~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","M_**↑","////⇑","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓"]
        row16 = ["~~~~⇓","~~~~⇓","~~~~⇓","m___↓","////⇑","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row17 = ["~~~~⇓","~~~~⇓","a___↓","~~~~↓","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row18 = ["~~~~⇓","a___↓","a___↓","A___|","~~~~↓","~~~~↓","////⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row19 = ["~~~~⇓","~~~~⇓","~~~~⇓","A___|","A___↑","////⇑","////⇑","D___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓"]
        row20 = ["~~~~⇓","~~~~⇓","~~~~⇓","))))↓","A___|","D___↑","////⇑","D_**⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row21 = ["~~~~⇓","~~~~⇓","a___↓","A___|","))))↓","))))↓","D___⇑","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓"]
        row22 = ["~~~~⇓","a___↓","a___↓","))))↓","A___↑","////⇑","D___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        row23 = ["~~~~⇓","~~~~⇓","))))↓","A___↑","////⇑","////⇑","////⇑","D___⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓"]
        row24 = ["~~~~⇓","~~~~⇓","a___↓","~~~~↓","~~~~↓","////⇑","////⇑","////⇑","~~~~⇓","~~~~⇓","~~~~⇓","~~~~⇓"]
        ...
        self.legend = {"a": "Ashen Shore", "A": "Ashen Forest", "D": "Dormant Volcano",
                        "m": "Mystic Shore", "M": "Mystic Forest",
                         "t": "Transcendent Highland", "T": "Transcendent Peak"}

        self.ace = "Ace"
        self.events = {"Landfall": {"location": [7, 1], "complete": False},
                        "Angler": {"location": [14, 4], "complete": False},
                         "Dragon": {"location": [19, 7], "complete": False}}
        self.marker = mapMarker(self.worldMap, [7, 1, 1])
