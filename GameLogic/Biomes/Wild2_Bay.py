...
def randomEncounters(roll, environment) -> list:
    ...
    match roll:
        case 1: members = Pass.randomSoldiers("elite", environment)
        case 2: members = randomBeasts("bear", environment, element)
        case 3: members = randomBeasts("moose", environment, element)
        case 4: members = randomBeasts("wyrm", environment, "Toxin")
        case 5: members = Pass.randomBeasts("lizard", environment, "Basic")
        case 6: members = Pass.randomBeasts("wasp", environment, "Toxin")
        case 7: members = Pass.randomBeasts("beetle", environment, "Basic")
        case 8: members = Pass.randomBeasts("isopod", environment, "Basic")
        case 9: members = Pass.randomBeasts("urchin", environment, "Basic")
        case 10: members = Pass.randomBeasts("deer", environment, "Basic")
        case 11: members = Pass.randomBeasts("rabbit", environment, "Basic")
