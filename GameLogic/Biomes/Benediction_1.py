...
def scrublandEncounters(roll, budget) -> list:
    ...
    match roll:
        ...
        case 5: members = RandomCreatures.creatures("scorpion", "Toxic", majorBiome, budget)
...
def encroachmentEncounter(roll, budget) -> list:
    ...
    match roll:
        ...
        case 6: members = RandomCreatures.creatures("scorpion", "Toxic", majorBiome, budget)
        case 7: members = RandomCreatures.creatures("camel", element, majorBiome, budget)
...
def locusEncounter(roll, budget) -> list:
    ...
    match roll:
        ...
        case 8: members = RandomCreatures.creatures("scorpion", "Toxic", majorBiome, budget)
