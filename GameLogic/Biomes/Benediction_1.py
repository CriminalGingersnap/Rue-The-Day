...
def scrublandEncounters(roll, budget) -> list:
    ...
    match roll:
        ...
        case 7: members = RandomCreatures.creatures("vulture", element, majorBiome, budget)
        case 8: members = RandomCreatures.creatures("centipede", "Toxic", majorBiome, budget)
        case 9: members = RandomCreatures.creatures("ant", "Toxic", majorBiome, budget)
...
def locusEncounter(roll, budget) -> list:
    ...
    match roll:
        ...
        case 8: members = RandomCreatures.creatures("centipede", "Toxic", majorBiome, budget)
        case 9: members = RandomCreatures.creatures("vulture", element, majorBiome, budget)
        case 10: members = RandomCreatures.creatures("crow", element, majorBiome, budget)
        case 11: members = RandomCreatures.creatures("beetle", "Holy", majorBiome, budget)
