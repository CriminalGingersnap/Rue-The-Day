...
class crow:
    def __init__(self, element, rank) -> None:
        ...
        abl = Characters.setAbilities(rank, type, {"attacks": ["Peck"], "boons": ["Rally"]})
...
class hawk:
    def __init__(self, element, rank) -> None:
        ...
        abl = Characters.setAbilities(rank, type, {"attacks": ["Kick", "Peck"]})
...
class ostrich:
    def __init__(self, element, rank) -> None:
        ...
        abl = Characters.setAbilities(rank, type, {"attacks": ["Kick"], "boons": ["Guard"]})
...
class macaw:
    def __init__(self, element, rank) -> None:
        ...
        abl = Characters.setAbilities(rank, type, {"attacks": ["Peck"], "hindrances": ["Confound"]})
        if rank == "Elder": abl["boons"] += ["Screen"]

        self.ch = Characters.character(abl, cndt, dice, element, "Macaw", rank, stats, type)
...
class vulture:
    def __init__(self, element, rank) -> None:
        ...
        abl = Characters.setAbilities(rank, type, {"attacks": ["Peck", "Spit"]})
