...
scenes = {"Leviathan": [
    ...
    ["> ", "I'm not sure how, but we're all still alive. Akeem credits providence; I see no reason to argue."],
    ...
    ["", ""],
    ["> ", "When I confronted her, she just opened her hand and showed me another coin of the same make."],
    ["  ", "Hers is tarnished and a little more crude, but it shows the same mountain."],
    ...
    ["  ", "The vampire believed no such curse still existed- if it ever had. He wrote this phrase in his journal:"],
    ["  ", "  'Despite its apparent intelligence, the lich is no more capable of innovation than any other dead thing.'"],
    ["  ", "I wonder if the bloodsucker counted himself..."],
    ["", ""],
    ...
    ["  ", "Before we get there, I should ask whether those paladins have any need for another ship captain."],
