...
scenes = {"Escape": [
    ...
    ["  ", "Its resident titan should prove easiest to hunt."],
    ["", ""],
    ...
    ["> ", "The Duke's best ranger pursued us personally."],
    ["  ", "He must have overtaken us last night to prepare his ambush."],
    ["  ", "At least we don't need to worry about running into him later."],
    ["", ""],
    ["> ", "His house knows nothing of our plan, so sending an assassin almost feels petty."],
    ...
    ["  ", "We'll need to craft what he needs ourselves."],
    ["", ""],
    ["> ", "Laura's almost convinced we should just strike now, but we agreed to follow the plan."],
