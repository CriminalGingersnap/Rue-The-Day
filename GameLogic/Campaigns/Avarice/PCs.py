...
def getLaura():
    ...
    Laura.atrb["base_av"], Laura.atrb["base_hp"], Laura.atrb["base_sp"] = 17, 15, 4
...
def getMartin():
    ...
    Martin.atrb["base_av"], Martin.atrb["base_hp"], Martin.atrb["base_sp"] = 16, 17, 5
...
def getWillem():
    ...
    Willem.atrb["base_av"], Willem.atrb["base_hp"], Willem.atrb["base_sp"] = 16, 14, 3
